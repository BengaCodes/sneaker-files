...
// ? Form to Edit existing trainer in TrainerEdit.js -> Export

const TrainerEditForm = ({name, brand, color, price, size, image, description, onSubmit, onChange}) =>{
  return(
    <section className="edit section is-medium">
    ...
    <form onSubmit={onSubmit}>
      <div className="field">
        ...
        <label className="label">Description</label>
          <div className="control">
            <textarea onChange={onChange} value={description} name="description" className="textarea is-medium" placeholder="Medium textarea"></textarea>
          </div>
          </div>
